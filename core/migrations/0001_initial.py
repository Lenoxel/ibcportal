    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "donate_type",
                    models.CharField(
                        choices=[("tithe", "Dízimo"), ("offer", "Oferta")],
                        max_length=20,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "nickname",
                    models.CharField(max_length=25, verbose_name="Conhecido como"),
                ),
                (
                    "description",
                    models.TextField(max_length=300, verbose_name="Descrição"),
                ),
                ("address", models.CharField(max_length=100, verbose_name="Endereço")),
                (
                    "church_function",
                    models.CharField(max_length=40, verbose_name="Função na Igreja"),
                ),
                (
                    "date_of_birth",
                    models.DateField(
                ...
                (
                    "picture",
                    models.ImageField(upload_to="pictures/", verbose_name="Foto"),
                ),
                (
                    "creation_date",
                    models.DateTimeField(auto_now_add=True, verbose_name="Criado em"),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "title",
                    models.CharField(max_length=200, verbose_name="Título da postagem"),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "title",
                    models.CharField(max_length=100, verbose_name="Título do vídeo"),
                ),
                (
                    "description",
                    models.TextField(
                ...
                (
                    "youtube_video_code",
                    models.CharField(max_length=150, verbose_name="Código do Youtube"),
                ),
                (
                    "registering_date",
                    models.DateTimeField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "dislike_count",
                    models.IntegerField(default=0, verbose_name="Não gostei"),
                ),
                (
                    "video",
                    models.OneToOneField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "post_file",
                    models.FileField(upload_to="post_files/", verbose_name="Arquivo"),
                ),
                (
                    "creation_date",
                    models.DateTimeField(auto_now_add=True, verbose_name="Criado em"),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "event_type",
                    models.CharField(max_length=30, verbose_name="Tipo do evento"),
                ),
                (
                    "price",
                    models.FloatField(blank=True, null=True, verbose_name="Valor (R$)"),
                ),
                (
                    "picture",
                    models.ImageField(
                        upload_to="event_images/", verbose_name="Imagem do evento"
                    ),
                ),
                (
                    "creation_date",
