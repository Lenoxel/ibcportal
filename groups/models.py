...
class Group(models.Model):
    ...
    another_leader = models.ForeignKey(
        "core.Member",
    ...
    vice_leader = models.ForeignKey(
        ...
        related_name="vice_leader",
        null=True,
        blank=True,
        on_delete=models.SET_NULL,
    )
    another_vice_leader = models.ForeignKey(
        "core.Member",
    ...
    third_leader = models.ForeignKey(
        "core.Member",
        verbose_name="Terceiro líder",
        related_name="third_leader",
        null=True,
        blank=True,
        on_delete=models.SET_NULL,
    )
...
class GroupMeetingDate(models.Model):
    ...
    def __str__(self):
        if self.end_date:
            return "{} - {}, {} às {}".format(
                self.group, self.day, self.start_date, self.end_date
            )
        else:
