...
class Group(models.Model):
    ...
    another_leader = models.ForeignKey('core.Member', verbose_name='Outro líder', related_name='another_group_leader', null=True, blank=True, on_delete=models.SET_NULL)
    ...
    another_vice_leader = models.ForeignKey('core.Member', verbose_name='Outro vice-líder', related_name='another_vice_leader', null=True, blank=True, on_delete=models.SET_NULL)
